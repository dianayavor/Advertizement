...
<body>
<div class="add-container-advert" align="center">
    <h1 class="label-add">Add advert: <i>${requestScope.advert.title}</i></h1>
    <form class="form-add-advert" method="post" action="adverts/add">
